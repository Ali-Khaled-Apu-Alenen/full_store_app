...
sealed class HomeState with _$HomeState {
  ...
  // const factory HomeState.getCategories() = _GetCategories;  // get categories
  const factory HomeState.getCategoriesLoading() = _GetCategoriesLoading;
  const factory HomeState.getCategoriesSuccess(CategorieResponseData data) = _GetCategoriesSuccess;
