...
@override
String toString() {
  return 'VerifyCodeState.success()';
}
...
class _Failure implements VerifyCodeState {
...
@override
String toString() {
  return 'VerifyCodeState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $VerifyCodeStateCopyWith<$Res> {
